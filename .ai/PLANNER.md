...
verified: 2026-09-17 · against `main` @ `1a8a9be` (project 26-09-17-01-updates closeout, post-merge —
gate table above updated: unit suite 526→530 (this row's own prior "521" was itself stale — see the
row's own note; no file-count change, both touched test files already existed), biome unmoved at
`121` (both files this project extended already existed; no new file), lint:tokens/check:css
untouched by this diff; prior verification `4f285a0`, 26-09-16-01-workflow-execution-runner closeout;
before that `2d4f404`, 26-09-11-00-fixes closeout)
